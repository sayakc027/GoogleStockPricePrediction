...
We can visualise that using the below graph:

```{r Visualising the impact of COVID, warning=FALSE, message=FALSE}

ggplot(forecast_during_covid, aes(x = Date, y = Actual.Values)) + geom_line() 
